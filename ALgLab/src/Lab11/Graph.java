...
public class Graph {
	...
	public boolean isConnected() {
		IsConnected isConn = new IsConnected(spanningTree);
		boolean ans = isConn.isConnected();
		if(!ans) System.out.println("Number of Components "+isConn.numberOfComponents());
		return ans;
	}
	//TO-DO
	public boolean hasPathBetween(Vertex u, Vertex v) {
		PathExists pe = new PathExists(spanningTree);
    ...
    int shortestPathLength(Vertex u, Vertex v) {
    	...
    	return sp.computeShortestPathLength(u, v);
    }
