package lab3.runtime;

import java.io.BufferedReader;
import java.io.FileReader;
import java.util.Stack;
import lab3.util.RandomPermutations;
import java.util.*;

import static lab3.util.Util.getClassNameNoPackage;


public class SortTester {
	private final String PACKAGE = "lab3.sortroutines";
	...
	public void runTests() {
		...
		while(!sorters.isEmpty()) {
			...
			String name = getClassNameNoPackage(nextSorter.getClass());
